...
class ExistentUser extends React.Component {
  /*
    ...
    return (
      <div> {/* DO NOT REMOVE THIS DIV COMPONENT*/}
        <div className = "fourohfour">
          <h2 className="textAboveSearch"><span style={STYLE.SPAN}>EXISTENT USER</span></h2>
          <h2><span style={STYLE.NAPS}>A user with this email already exists!</span> </h2> 
...
export default withRouter (ExistentUser)
