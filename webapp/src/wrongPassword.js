    ...
    return (
      <div> {/* DO NOT REMOVE THIS DIV COMPONENT*/}
        <div className = "fourohfour">
          <h2 className="textAboveSearch"><span style={STYLE.SPAN}>WRONG PASSWORD</span></h2>
          <h2><span style={STYLE.NAPS}>The password was incorrect!</span> </h2>
...
export default withRouter (WrongPassword)
